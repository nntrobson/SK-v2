                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-slate-700/50 bg-slate-900/40">
                        <th className="px-8 py-5 text-xs font-semibold text-slate-400 uppercase tracking-wider w-[50%]">Location Matrix</th>
                          ...
                          <td className="px-8 py-6">
                            {session.status === 'processing' ? (
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sky-400 font-medium italic animate-pulse tracking-wide text-sm">Processing Neural Track...</span>
                              </div>
                            ) : (
